var stringHtml = '<div class="input_div input-group">' + 
					'<span class="input-group-addon" >value</span>' + 
					'<input name="value" type="text" class="form-control" placeholder="value" >' + 
				'</div>' ;

var listHtml =  '<div class="input_div input-group">' + 
					'<span class="input-group-addon">value</span>' + 
...
var setHtml = '<div class="input_div input-group">' + 
				'<span class="input-group-addon">value</span>' + 
				'<input name="value" type="text" class="requireds form-control" placeholder="value"  > ' + 
				'<span class="input-group-btn">' + 
...
var zsetHtml = '<div class="input_div input-group col-sm-12 col-lg-12">' + 
					...
					'</div>' + 
				'</div>' ;
var hashHtml = '<div class="input_div input-group col-sm-12 col-lg-12">' + 
					'<div class="row col-sm-12 col-lg-12">' + 
						'<div class="col-sm-6 col-lg-6">' + 
							'<div class="input-group col-sm-12 col-lg-12">' + 
...
var clearLineHtml = '<div class="col-sm-12">' + 
						'<br>' + 
					'</div>' ;